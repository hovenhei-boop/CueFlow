...
Project Lexicon/Official Packs 对 Source 的实际消费、相关性检索与容量预算、不可变 Effective Glossary Snapshot、证据融合、PPT/板书/屏幕画面补充抽取和 UI 均不在当前实现内。v0.4.1 不允许新词库状态改变现有 Effective Glossary、Source stale 状态或 SRT。
